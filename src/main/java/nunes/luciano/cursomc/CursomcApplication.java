...
import nunes.luciano.cursomc.domain.PagamentoComBoleto;
import nunes.luciano.cursomc.domain.PagamentoComCartao;
...
import nunes.luciano.cursomc.repositories.ItemPedidoRepository;
import nunes.luciano.cursomc.repositories.PagamentoRepository;
...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Categoria cat5 = new Categoria(null, "Jardinajem");
		...
		cat3.getProdutos().addAll(Arrays.asList(p1,p2,p3,p7));
